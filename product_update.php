...
<div class="cart-view-table-back">
	...
	<form method="POST" action="product_list.php" enctype="multipart/form-data">
	<div class="form">
		<div class="input">
		...
		<div class="input">
			...
			<input name="product_description" id="product_description" value="<?= $row['product_description']?>">
		</div>
		<div class="input">
		...
		<div class="input">
			...
			<input name="product_photo" type="file" id="product_photo" value="<?= $row['photo']?>">
		</div>
		<div class="input">
